...
(function() {
  ...
  Example = (function() {
    function Example(el) {
      var border;
      this.$el = $(el);
      this.$frame = this.$el.find('.example__iframe');
      this.$devMobile = this.$el.find('.example__device-selection__mobile');
      this.$devTablet = this.$el.find('.example__device-selection__tablet');
      this.$devDesktop = this.$el.find('.example__device-selection__desktop');
      this.$devMobile.on('click', this.setWidth.bind(this, '320px', this.$devMobile));
      this.$devTablet.on('click', this.setWidth.bind(this, '768px', this.$devTablet));
      this.$devDesktop.on('click', this.setWidth.bind(this, null, this.$devDesktop));
      border = this.$el.find('.example__border');
      this.borderPadding = parseInt(border.css('padding-left')) + parseInt(border.css('padding-right'));
      this.setWidth(null, this.$devDesktop);
    }

    Example.prototype.setWidth = function(width, activeBtn) {
      var w;
      this.$devMobile.removeClass('is-active');
      this.$devTablet.removeClass('is-active');
      this.$devDesktop.removeClass('is-active');
      activeBtn.addClass('is-active');
      w = width === null ? this.$el.width() - this.borderPadding + 'px' : width;
  ...
  $(function() {
    return $(".example").each(function(i, el) {
      return new Example(el);
    });
  });
...
(function() {
  (function($) {
    var IFrameResizer, Plugin;
    IFrameResizer = (function() {
      function IFrameResizer(el, options) {
        this.$el = $(el);
        iFrameResize({
          autoResize: true,
          resizeFrom: 'child',
    ...
    return $(function() {
      return $('[data-iframe-resizer]').each(function() {
        var $el, data;
        $el = $(this);
        data = $el.data();
...
(function() {
  (function($) {
    return $(function() {
      return $('.left__menu .menu__level').each(function(i, el) {
        var $el, $headline;
        $el = $(el);
        ...
        return $headline.on('click', function(e) {
          ...
          return $el.slideToggle('fast', function() {
            return $el.toggleClass('is-open');
          });
        });
      });
    });
...
(function() {
  (function($) {
    var getRandomOctocat, octodex;
    octodex = ["https://octodex.github.com/images/jetpacktocat.png", "https://octodex.github.com/images/topguntocat.png", "https://octodex.github.com/images/femalecodertocat.png", "https://octodex.github.com/images/daftpunktocat-thomas.gif", "https://octodex.github.com/images/daftpunktocat-guy.gif", "https://octodex.github.com/images/foundingfather_v2.png", "https://octodex.github.com/images/poptocat_v2.png", "https://octodex.github.com/images/Professortocat_v2.png", "https://octodex.github.com/images/goretocat.png", "https://octodex.github.com/images/gangnamtocat.png", "https://octodex.github.com/images/spidertocat.png", "https://octodex.github.com/images/stormtroopocat.png", "https://octodex.github.com/images/pusheencat.png", "https://octodex.github.com/images/deckfailcat.png", "https://octodex.github.com/images/murakamicat.png", "https://octodex.github.com/images/homercat.png", "https://octodex.github.com/images/minion.png", "https://octodex.github.com/images/octofez.png", "https://octodex.github.com/images/heisencat.png", "https://octodex.github.com/images/red-polo.png", "https://octodex.github.com/images/twenty-percent-cooler-octocat.png", "https://octodex.github.com/images/momtocat.png", "https://octodex.github.com/images/front-end-conftocat.png", "https://octodex.github.com/images/snowoctocat.png", "https://octodex.github.com/images/adventure-cat.png", "https://octodex.github.com/images/herme-t-crabb.png", "https://octodex.github.com/images/orderedlistocat.png", "https://octodex.github.com/images/thanktocat.png", "https://octodex.github.com/images/baracktocat.jpg", "https://octodex.github.com/images/waldocat.png", "https://octodex.github.com/images/riddlocat.png", "https://octodex.github.com/images/oktobercat.png", "https://octodex.github.com/images/shoptocat.png", "https://octodex.github.com/images/bear-cavalry.png", "https://octodex.github.com/images/poptocat.png", "https://octodex.github.com/images/cherryontop-o-cat.png", "https://octodex.github.com/images/supportcat.png", "https://octodex.github.com/images/agendacat.png", "https://octodex.github.com/images/spocktocat.png", "https://octodex.github.com/images/swagtocat.png", "https://octodex.github.com/images/trekkie.png", "https://octodex.github.com/images/bouncercat.png", "https://octodex.github.com/images/pythocat.png", "https://octodex.github.com/images/repo.png", "https://octodex.github.com/images/benevocats.png", "https://octodex.github.com/images/puppeteer.png", "https://octodex.github.com/images/class-act.png", "https://octodex.github.com/images/original.png"];
    getRandomOctocat = function() {
      return octodex[Math.floor(Math.random() * (octodex.length - 1))];
    };
    return $(document).ready(function() {
      return $('[data-octocat]').each(function(index, element) {
        return element.src = getRandomOctocat();
      });
    });
  })(jQuery);
...
(function() {
  var KEY_DOWN, KEY_ENTER, KEY_UP, Search, getSearchData, searchData;
  ...
  Search = (function() {
    function Search(input) {
      ...
      this.error = false;
      this.$input = $(input);
      this.$suggestions = $('<div class="autocomplete__suggestions"></div>');
      ...
      this.$input.on('focus blur', (function(_this) {
        return function() {
          return _this.updateDisplay();
        };
      })(this));
    ...
    Search.prototype.openSelected = function() {
      var $current;
      $current = $(this.$suggestions.children('.autocomplete__suggestions__item--selected')[0]);
    ...
    Search.prototype.selectPrevious = function() {
      var $current, $prev;
      $current = $(this.$suggestions.children('.autocomplete__suggestions__item--selected')[0]);
      $prev = $current.prev();
    ...
    Search.prototype.fail = function(jqXHR, textStatus, errorThrown) {
      this.error = true;
      return this.updateDisplay();
    };

    Search.prototype.initIndex = function(data, textStatus, jqXHR) {
    ...
    Search.prototype.updateDisplay = function() {
    ...
    Search.prototype.hideDisplay = function() {
      return this.$suggestions.empty();
    };

    Search.prototype.displayError = function() {
      var $error;
    ...
    Search.prototype.displayLoading = function() {
      var $loading;
    ...
    Search.prototype.displayResult = function() {
      var first, j, len, ref, res, result, results, term;
      results = [];
      term = this.$input.val().trim();
      if (term !== '') {
        res = this.lunrIdx.search(term);
        ref = res.slice(0, 5);
        for (j = 0, len = ref.length; j < len; j++) {
          ...
          results.push(((function(_this) {
            return function() {
              var $res, $tags, data;
              data = _this.searchData.pages[result.ref];
              $res = $('<div class="autocomplete__suggestions__item"></div>');
              $res.text(data.title);
              $res.on('click', function() {
                return window.location.href = _this.baseUrl + data.link;
              });
  ...
  getSearchData = function(searchDataUrl) {
  ...
  $(function() {
    return $("[data-search]").each(function(i, el) {
  ...
  (function($) {
    ...
    Tab = (function() {
      function Tab(element, options) {
        ...
        this.$toggles.on('click', this, function(event) {
          return event.data.toggle(event);
        });
        defaultSelector = this.$element.data('tab-default');
      ...
      Tab.prototype.setActiveTab = function(tabName) {
    ...
    return $(window).on('load', function() {
      return $('[data-tab]').each(function(index, element) {
...
//# sourceMappingURL=docs.all.min.js.map